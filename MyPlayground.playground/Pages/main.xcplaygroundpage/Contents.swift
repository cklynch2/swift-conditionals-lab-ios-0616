...
*/
// write your code here
func isGreater(intOne intOne: Int, intTwo: Int) -> Bool {
    if (intOne > intTwo) {
        return true
    } else {
        return false
...
*/
// write your code here
func payMeTenBucks (myBalance myBalance: Int, yourBalance: Int) {
    if (yourBalance > 10) {
        let myNewBalance = myBalance + 10
        let yourNewBalance = yourBalance - 10
        print("Now I have $\(myNewBalance) and you have $\(yourNewBalance).")
    }
}

payMeTenBucks(myBalance: 35, yourBalance: 800)
